...
const RetailerAddProduct = () => {
  ...
  // ✅ VARIANTS STATE (Multiple sizes with different prices)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // ✅ Calculate global pricing status from all variants
  ...
  //onst categoryName = selectedMainCategory?.name?.toLowerCase() || '';
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          {/* Basic Information - SAME AS SUPPLIER */}
          ...
          {/* Category Selection - SAME AS SUPPLIER */}
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div className="mt-3 bg-orange-50 border border-orange-200 rounded-lg p-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <Link
                            to={`/retailer/products/edit/${existingProducts.productMap?.get(formData.variety)?._id}`}
                ...
                <div className="bg-yellow-50 border-2 border-yellow-300 rounded-lg p-4 space-y-3">
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-sm text-yellow-900">
                      <strong>Adding a new variety:</strong> Your product will be pending admin approval. Once approved, this variety will be available for all sellers.
                    </p>
                  </div>
          ...
          {/* ✅ SIZE VARIANTS WITH PRICING - SAME AS SUPPLIER */}
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center gap-4">
                <div className="bg-purple-100 text-purple-700 px-4 py-2 rounded-lg font-bold border border-purple-200">
              ...
              <div>
                <h4 className={`font-bold text-sm ${
                  ...
                  Important: Stock is in {
                    mainCategoryName.toLowerCase().includes('seed') ? 'PACKETS' :
                ...
                <p className={`text-xs mt-1 leading-relaxed ${
                  ...
                  As a retailer, you sell in <strong>individual consumer units</strong>.
                  {mainCategoryName.toLowerCase().includes('seed') ? 
                    ' Example: If you have 200 packets of seeds, enter 200 in the stock field below.' :
                    ' Example: If you have 50 bottles of pesticide, enter 50 in the stock field below.'
                  }
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              {variants.map((variant, index) => (
                <div key={variant.id} className={`border-2 rounded-xl p-4 ${variant.isDefault ? 'border-purple-500 bg-purple-50' : 'border-gray-200 bg-white'}`}>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                    {/* Size, Unit, Base Price, Offer Price, Stock - SAME AS SUPPLIER */}
                    <div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-6 pr-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-purple-500 outline-none"
                          placeholder="0"
                          step="0.01"
                          required
                        />
            ...
            <div className="mt-6 bg-gradient-to-r from-purple-50 to-purple-100 border border-purple-200 rounded-lg p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-purple-700">Total Stock Across All Variants:</p>
                  <p className="text-xs text-purple-600 mt-1">Combined stock from all size variants</p>
                </div>
                <div className="text-right">
                  <p className="text-3xl font-bold text-purple-700">
                    {variants.reduce((sum, v) => sum + (parseInt(v.stock) || 0), 0)}
                  </p>
                  <p className="text-xs text-purple-600">units total</p>
                </div>
              </div>
            </div>

            {/* ✅ OFFER SCHEDULING - NEW */}
            <div className="mt-8 p-4 bg-purple-50 rounded-xl border-2 border-purple-200">
              <div className="flex items-center gap-2 mb-2">
                ...
                />
                <label htmlFor="hasOffer" className="font-bold text-purple-900 cursor-pointer">
                  Enable Offers & Scheduling
                </label>
              </div>
              <p className="text-xs text-purple-700 mb-4 ml-7">
                Must be checked to activate "Offer Prices" entered above. Add dates to schedule a future offer.
              </p>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-4">
              <div className="border-2 border-dashed border-purple-300 rounded-lg p-8 bg-purple-50 text-center">
                <input
                  type="file"
                  id="image-upload"
                  accept="image/*"
                ...
                <label htmlFor="image-upload" className="cursor-pointer">
                  <HiUpload className="w-12 h-12 text-purple-600 mx-auto mb-3" />
              ...
              <div className="pt-8 border-t border-gray-200 space-y-6">
                    ...
                    {formData.faq.map((item, index) => (
                      <div key={index} className="p-4 border border-gray-200 rounded-xl bg-gray-50 space-y-3 relative">
                        ...
                        <input
                          ...
                          className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 outline-none bg-white font-medium"
                        ...
                        <textarea
                          ...
                          rows="2"
                          className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 outline-none bg-white resize-none"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    rows="2"
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 outline-none bg-gray-50 text-gray-600 text-sm italic"
                  />
                </div>
              </div>
            </div>
              ...
              {formData.hasExpiry && (
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className="w-full md:w-1/2 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none transition-all"
                  />
                </div>
              )}
            </div>
          ...
          <div className="flex gap-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex-1 bg-purple-600 hover:bg-purple-700 disabled:bg-gray-400 text-white font-semibold py-3 px-6 rounded-lg transition-all flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
